...
my $usage = "\nUsage [$version]: 
    ...
    -f,--file  (string) file 
    -n, --number of individuals (STRING) split by the number of individuals	(max no of jobs submitted for the parellel = total number of individuals/number of individuals given in this option )
